...
**Init[0]** adalah platform pembelajaran interaktif berbasis web (E-Learning) yang dirancang secara khusus untuk persiapan **Lomba Kompetensi Siswa (LKS) Tingkat Provinsi Jawa Timur Tahun 2026** pada bidang **Cyber Security**.
...
- 📚 **Silabus Lengkap LKS 2026**: Struktur navigasi mencakup seluruh (~50) topik uji mulai dari *Infrastructure Hardening*, *Web Exploitation*, *Binary Exploitation*, hingga *Digital Forensics* dan *SOC*.
